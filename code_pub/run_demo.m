...
%% 0 setttings
dx       = 0.0125;                          % space mesh size
N        = 3;                             %  number of data pairs (u_i,f_i)
u_Type      = 'Fourier';   supp_u = [-1*pi 1*pi];  % data u
kernel_type = 'Gaussian';       % Gaussian, sinkx, FracLap
...
noise_ratio            = 0;  obsInfo.noise_ratio  = noise_ratio;                                 % noise to signal ratio
