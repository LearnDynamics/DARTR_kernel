...
for nn = 1:length(normType)
    ...
    switch norm_type
        case 'l2'     %% 1. Tikhonov regulariztion, norm_type = 'l2';
            ...
            [x_reg,lambda_opt] = Lcurve_with_Norm_pinv(Abar,bbar,Bmat,titl,plotON);
        ...
        case 'H1'
            ...
            titl      = ['L-curve with norm: ',norm_type];
            [x_reg,lambda_opt] = Lcurve_with_Norm_pinv(Abar,bbar,BH1,titl,plotON);
        ...
        case 'H2'
            ...
            titl      = ['L-curve with norm: ',norm_type];
            [x_reg,lambda_opt] = Lcurve_with_Norm_pinv(Abar,bbar,BH2,titl,plotON);
